...
public class CreateTableLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"CREATE", "TABLE", "VARCHAR", "CHAR", "INT", "INTEGER", "BIGINT", "DECIMAL", 
			"FLOAT", "DOUBLE", "DATE", "DATETIME", "TIMESTAMP", "TEXT", "BOOLEAN", 
			"NOT", "NULL", "PRIMARY", "KEY", "UNIQUE", "AUTO_INCREMENT", "DEFAULT", 
			"TRUE", "FALSE", "LPAREN", "RPAREN", "COMMA", "IDENTIFIER", "NUMBER", 
			"STRING", "WS", "A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", 
